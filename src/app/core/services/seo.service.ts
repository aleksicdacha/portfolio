...
export class SeoService {
  ...
  readonly baseDescription = 'Experienced Full-Stack Developer with 20+ years of expertise in Angular, React, Node.js, PHP, and modern web technologies.';
  ...
  private setMetaTag(attrName: string, attrValue: string, content: string): void {
    let el = this.doc.querySelector(`meta[${attrName}="${attrValue}"]`) as HTMLMetaElement | null;
    if (!el) {
