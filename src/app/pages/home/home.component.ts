...
@Component({
  ...
  template: `
    ...
    <section class="hero section" aria-labelledby="hero-title">
      <div class="container hero-grid">
        ...
        <!-- Quick Facts -->
        <aside class="hero-facts" [class.visible]="isVisible()" aria-label="Quick facts">
            ...
            <article class="featured-card" [class.first]="$first">
              <div class="featured-card-inner">
                ...
                <div class="featured-body">
                  ...
                  <a [routerLink]="['/projects', project.slug]" class="featured-cta">
                    View project →
                  </a>
                </div>
              </div>
    ...
    <section class="exp-teaser section-alt" aria-labelledby="exp-title">
      <div class="container exp-grid">
        <div class="exp-text">
          <h2 class="section-title" id="exp-title">20+ Years of Building for the Web</h2>
          <p class="exp-lead">{{ summary }}</p>
          <a class="btn-outline" routerLink="/experience">View full experience →</a>
        </div>
        <dl class="exp-stats">
  ...
  styles: [`
    ...
    .hero-facts { transition-delay: 0.15s; }
    .hero-eyebrow {
    ...
    /* Featured Projects */
    .featured-projects { padding: var(--space-20) 0; }
    .featured-grid {
      display: grid;
    ...
    .featured-card {
      ...
      &:hover { transform: translateY(-4px); box-shadow: var(--shadow-lg); border-color: var(--color-accent); }
    }
    .featured-img {
      aspect-ratio: 16/9;
      overflow: hidden;
    ...
    .featured-body { padding: var(--space-6); display: flex; flex-direction: column; gap: var(--space-3); }
    .featured-meta {
      display: flex;
      gap: var(--space-2);
      font-size: 0.75rem;
      color: var(--color-text-tertiary);
      span + span::before { content: '·'; margin-right: var(--space-2); }
    }
    .featured-title { font-size: 1.125rem; font-weight: 600; color: var(--color-text); margin: 0; }
    .featured-desc { font-size: 0.875rem; color: var(--color-text-secondary); margin: 0; line-height: 1.6; }
    .featured-tech { display: flex; flex-wrap: wrap; gap: var(--space-2); }
    .tech-pill {
      padding: 2px 10px;
      font-size: 0.6875rem;
      font-weight: 600;
    ...
    /* Experience teaser */
    .exp-teaser { padding: var(--space-20) 0; }
    ...
    @media (prefers-reduced-motion: reduce) {
      .hero-content, .hero-facts { transition: none; opacity: 1; transform: none; }
    ...
    @media (max-width: 1024px) {
      ...
      .fact-card { min-width: 140px; flex: 1; border-bottom: none; border-right: 1px solid var(--color-border); &:last-child { border-right: none; } padding: 0 var(--space-4); }
    ...
    @media (max-width: 640px) {
      ...
      .fact-card { border-right: none; border-bottom: 1px solid var(--color-border); padding: var(--space-3) 0; }
