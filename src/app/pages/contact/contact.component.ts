...
@Component({
    ...
    <div class="page-contact">
      ...
      <section class="contact-hero section">
        <div class="container">
          ...
          <p class="contact-lead">I'm open to new opportunities, interesting projects, and collaborations. Drop me a message and I'll get back to you.</p>
        </div>
      </section>
      ...
      <section class="section-sm contact-body">
        <div class="container contact-grid">
          ...
          <div class="contact-primary" aria-label="Email contact">
            ...
            <p class="contact-card-desc">The best way to reach me. I typically respond within 24 hours.</p>
            <div class="email-actions">
              <a class="btn-primary btn-lg" [href]="mailtoLink" [attr.aria-label]="'Send email to ' + email">
                Send Email →
              </a>
              <button
                class="btn-copy"
                ...
                [attr.aria-label]="clipboard.copied() ? 'Email copied!' : 'Copy email address'"
                [attr.title]="clipboard.copied() ? 'Copied!' : 'Copy to clipboard'"
              >
                @if (clipboard.copied()) {
      ...
      <section class="section-sm contact-form-section" aria-labelledby="form-title">
        <div class="container form-container">
          <h2 class="section-title" id="form-title">Send a Message</h2>
          <p class="form-note">This form opens your email client with a pre-filled message — no server involved.</p>
          <form class="contact-form" (submit)="sendForm($event)" novalidate aria-label="Contact form">
            <div class="form-row">
            ...
            <button type="submit" class="btn-primary btn-lg">Open In Email Client →</button>
          </form>
        </div>
      </section>
    </div>
  `,
  styles: [`
    .page-contact { padding-bottom: var(--space-20); }
    ...
    /* Contact Grid */
    .contact-body { padding-bottom: var(--space-16); }
    .contact-grid {
      display: grid;
    ...
    .contact-primary, .contact-social, .contact-info {
      padding: var(--space-8);
      background: var(--color-surface);
      border: 1px solid var(--color-border);
      border-radius: var(--radius-md);
    }
    .contact-primary { grid-column: 1 / 2; }
    .contact-card-title {
    ...
    .email-actions { display: flex; flex-direction: column; gap: var(--space-3); }
    .btn-copy {
      display: inline-flex;
      align-items: center;
      gap: var(--space-2);
      ...
      &.copied { border-color: var(--color-success, #16a34a); color: var(--color-success, #16a34a); background: rgba(22,163,74,0.06); }
      &:focus-visible { outline: 2px solid var(--color-accent); outline-offset: 2px; }
    }

    /* Social list */
    .social-list { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: var(--space-2); }
    .social-item {
      display: flex;
      align-items: center;
      gap: var(--space-4);
    ...
    .social-icon { font-size: 1.125rem; width: 24px; text-align: center; flex-shrink: 0; }
    .social-label { flex: 1; font-size: 0.9375rem; font-weight: 500; }
    .social-arrow { color: var(--color-text-tertiary); font-size: 0.875rem; }
    ...
    .info-dl {
      ...
      gap: var(--space-4);
      div { display: flex; justify-content: space-between; align-items: center; gap: var(--space-4); }
      dt { font-size: 0.8125rem; font-weight: 500; color: var(--color-text-tertiary); flex-shrink: 0; }
      dd { font-size: 0.9375rem; font-weight: 500; color: var(--color-text); text-align: right; }
    }
    .status-available { display: flex; align-items: center; gap: var(--space-2); color: #16a34a !important; }
    .status-dot {
    ...
    /* Contact Form */
    .contact-form-section { padding-bottom: var(--space-8); }
    .form-container { max-width: 720px; }
    .form-note {
      font-size: 0.875rem; color: var(--color-text-tertiary); margin: var(--space-2) 0 var(--space-8);
    }
...
export class ContactComponent {
  ...
  sendForm(event: Event): void {
    ...
    const subject = encodeURIComponent(this.formSubject || 'Hello from portfolio');
