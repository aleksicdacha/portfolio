...
@Component({
  ...
  template: `
    <header class="nav-header" [class.scrolled]="scrolled()" [class.menu-open]="menuOpen()">
      <div class="nav-inner container">
        ...
        <div class="nav-actions">
          <app-theme-toggle />
          <a class="btn-outline btn-sm" [href]="cvUrl" download aria-label="Download CV">
            CV ↓
          </a>
          <!-- Hamburger -->
          <button
      ...
      <!-- Mobile Menu -->
      <div id="mobile-menu" class="mobile-menu" [class.open]="menuOpen()" role="dialog" aria-modal="true" aria-label="Mobile navigation">
